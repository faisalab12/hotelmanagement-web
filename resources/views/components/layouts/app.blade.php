...
<body>
    ...
    <header id="header" class="header fixed-top d-flex align-items-center">
        ...
        <div class="d-flex align-items-center justify-content-between">
            <a href="/Dashboard" class="logo d-flex align-items-center">
                ...
                <span class="d-none d-lg-block">Hotel Plaza</span>
            </a>
            ...
            <ul class="d-flex align-items-center">
                ...
                <li class="nav-item dropdown pe-3">
                    ...
                    <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown">
                        ...
                        <span class="d-none d-md-block dropdown-toggle ps-2">Mira</span>
    ...
    <footer id="footer" class="footer">
        <div class="copyright">
            &copy; Copyright 2024<strong><span>PlazaHotel</span></strong>. All Rights Reserved
        </div>
        <div class="credits">
            ...
            Developed by <a href="https://bootstrapmade.com/">RootDev</a>
        </div>
    </footer><!-- End Footer -->
