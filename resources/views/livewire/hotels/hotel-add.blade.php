<div>
    ...
    <main id="main" class="main">
        ...
        <div class="pagetitle">
            <h1>Tambah Daftar Hotel</h1>
            <nav>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="/Dashboard">Home</a></li>
                    <li class="breadcrumb-item"><a href="/Daftar-Hotel">Daftar Hotel</a></li>
                    <li class="breadcrumb-item active"><a href="/Add-Hotel">Tambah Daftar Hotel</a></li>
                </ol>
            </nav>
        </div><!-- End Page Title -->
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="card-title">
                                <div class="row">
                                    <div class="col-6">
                                        <h2 class="card-title">Tambah Daftar Hotel</h2>
                                    </div>
                                    <div class="col-6">
                            ...
                            <form wire:submit.prevent="AddHotel">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input wire:model="check_in_time" type="time" class="form-control" required>
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input wire:model="check_out_time" type="time" class="form-control" required>
                                    </div>
                                </div>
